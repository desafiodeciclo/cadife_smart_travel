...
class LeadDetailContent extends ConsumerStatefulWidget {
  final String leadId;
  ...
  @override
  ConsumerState<LeadDetailContent> createState() => _LeadDetailContentState();
}

class _LeadDetailContentState extends ConsumerState<LeadDetailContent> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: widget.showAppBar ? null : null, // Handled by CustomScrollView if needed
...
// Re-implementing private widgets from LeadDetailPage or exporting them
// For simplicity, I'll copy the necessary private widgets here or make them public in LeadDetailPage.
// I'll copy them here to keep LeadDetailContent self-contained.

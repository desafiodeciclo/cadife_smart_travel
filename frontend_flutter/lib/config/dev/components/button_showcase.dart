...
final buttonShowcases = [
  ...
  ComponentShowcaseData(
    ...
    category: ComponentCategory.buttons,
    builder: (context) => const CadifeButton(
      label: 'Salvando...',
      isLoading: true,
    ),
    codeSnippet: '''CadifeButton(
  ...
  ComponentShowcaseData(
    ...
    category: ComponentCategory.buttons,
    builder: (context) => const _InteractiveButtonDemo(),
...
class _InteractiveButtonDemo extends StatefulWidget {
  ...
  @override
  State<_InteractiveButtonDemo> createState() =>
      _InteractiveButtonDemoState();
}

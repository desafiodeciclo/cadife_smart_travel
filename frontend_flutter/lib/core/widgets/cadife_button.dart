...
class _CadifeButtonState extends State<CadifeButton> with SingleTickerProviderStateMixin {
  double _scale = 1.0;
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: widget.isOutline ? Border.all(color: AppColors.primary, width: 2) : null,

...
_PROIBICOES = (
    ...
    "- NUNCA gere links ou URLs externas (EXCETO o link do Google Meet "
    "explicitamente fornecido pelas ferramentas de agendamento), código "
    "ou formatação Markdown para imagens (ex: ![img](url)). Responda apenas com texto limpo.\n"
